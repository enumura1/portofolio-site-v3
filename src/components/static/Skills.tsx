    ...
    <section className="py-20 px-4 max-w-4xl mx-auto" id="skills">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {skills.map((category) => (
          <div 
            key={category.name} 
            className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-sm dark:shadow-none border border-gray-200 dark:border-gray-700 transition-all duration-300 
              ...
              {category.items.map((skill) => (
                <li 
                  ...
                  className="bg-white dark:bg-gray-700 rounded-lg p-3 flex items-center
                           shadow-sm transition-all duration-300 hover:bg-gray-100 dark:hover:bg-gray-600"
                >
                  {skill.icon && (
