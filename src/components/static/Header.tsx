    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50">
        <div className="mx-auto px-4">
          <div className="backdrop-blur-md bg-white/80 dark:bg-white/10 border border-gray-200/30 dark:border-white/20 rounded-2xl m-4 shadow-lg transition-all duration-300">
            <div className={`flex items-center justify-between px-10 transition-all duration-300 ${
